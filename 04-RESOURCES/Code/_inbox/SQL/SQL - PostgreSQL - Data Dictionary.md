...
aliases:
  ...
  - SQL - PostgreSQL - Data Dictionary Queries
  - SQL - PostgreSQL - Data Dictionary
publish: true
permalink:
description:
cssclasses:
...
> [!SOURCE] Sources:
> [sql_scripts/postgresql/data_dictionary/data_dict_dump.sql at main · DataResearchLabs/sql_scripts](https://github.com/DataResearchLabs/sql_scripts/blob/main/postgresql/data_dictionary/data_dict_dump.sql)
...
*Note created on [[2026-02-22]] and last modified on [[2026-02-22]].*
...
```dataview
LIST FROM [[SQL - PostgreSQL - Data Dictionary]] AND -"CHANGELOG"
```
